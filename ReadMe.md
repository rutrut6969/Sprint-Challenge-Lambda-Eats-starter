...
2. How would you explain form validation to someone who has never programmed before?
   Form validation basically let's you ensure that users fill out all the required information.

3. In 1-2 sentences, define end to end testing.
   End to end testing is a testing system that allows you to ensure that everything is working properly. And everything is posting properly.
